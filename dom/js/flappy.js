...
function Barreira (reversa = false) {
  this.elemento = novoElemento('div', 'barreira') // When i use 'this.' in a function, the created element will be visible outside of function too.
  // So, using the 'this.', the created element becomes public
